...
The Mega-Cap Technology Drawdown report is maintained as Markdown and rendered
with the shared institutional cover, contents page, section styling, running
headers, page numbers and PDF navigation with:

```bash
npm run build:mega-cap-drawdown-report
```

Source: `content/drafts/mega-cap-technology-drawdown-framework.md`
