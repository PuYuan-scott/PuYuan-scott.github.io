---
title: "The Coca-Cola Company (KO): A Post-CCBA Intrinsic Value Assessment"
subtitle: Post-CCBA Cash-Flow Reconstruction, Scenario Valuation and IRS Risk Assessment
author: Scott Yuan Research
date: August 19, 2026
subject: Equity research and intrinsic valuation of The Coca-Cola Company following the CCBA transaction
keywords:
  - Coca-Cola
  - KO
...
# Investment Case and Valuation Architecture
...
## Valuation Scope and Input Framework
...
# Reconstructing the Post-CCBA Operating Baseline

## Estimating the CCBA Revenue Base
...
## Extending the Baseline to 2026 on a Consistent Perimeter
...
# Forecast Assumptions and Scenario Construction

## Constructing the Revenue Growth Path
...
## Margin, Tax, and Reinvestment Assumptions
...
## Integrated Bear, Base, and Bull Definitions
...
|---|---:|---:|---:|
| 2027–2031 revenue growth | 3.2% $\rightarrow$ 2.6% | 4.7% $\rightarrow$ 3.5% | 5.5% $\rightarrow$ 4.0% |
| 2027–2031 operating margin | 32.7% $\rightarrow$ 32.5% | 33.7% $\rightarrow$ 34.1% | 34.2% $\rightarrow$ 35.2% |
| Normal tax rate | 21.0% | 20.0% | 19.5% |
| D&A as a percentage of revenue | 1.7% | 1.7% | 1.7% |
| 2027–2031 CapEx as a percentage of revenue | 3.8% $\rightarrow$ 3.4% | 3.6% $\rightarrow$ 3.2% | 3.5% $\rightarrow$ 3.1% |
...
# Cash Flow Forecast, Cost of Capital, and Terminal Value

## Explicit-Period FCFF Forecast
...
# Enterprise-to-Equity Bridge and IRS Risk

## Converting Enterprise Value into Common Equity Value
...
## Valuing the IRS Contingent Exposure
...
# Scenario Outcomes and Sensitivity Analysis
...
## Single-Factor Sensitivity and Multiple Cross-Check
...
# What Matters Next and Final Assessment

## Evidence That Would Confirm or Challenge the Model
...
# Appendix A: Sources and Input Classification {.unnumbered}
...
# Appendix B: Assumption Ledger and Exact Scenario Changes {.unnumbered}
...
# Appendix C: Formula Set and Fully Worked 2027 Example {.unnumbered}
...
# Appendix D: Validation, Limitations, and Non-Interchangeable Measures {.unnumbered}
...
# Appendix E: Reproduction and File Map {.unnumbered}
