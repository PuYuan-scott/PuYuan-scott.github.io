...
## Why Business Fundamentals Must Precede Drawdown Analysis
...
`Recurrence Interval = Complete Observation Years / Years Meeting the Threshold`

**Annual Historical Probability** expresses the same count as a percentage:

`Historical Frequency = Years Meeting the Threshold / Complete Observation Years`

These are descriptive sample statistics, not forecasts or guarantees.

---

# Current Business Mix and Growth Analysis

## NVIDIA — AI Infrastructure Concentration
...
Under the previous disclosure, Data Center Compute reached $60.4B, up 77%, while Data Center Networking reached $14.8B, up 199%. NVIDIA now reports Gaming, workstation, automotive, robotics, and other edge applications together as Edge Computing.
...
## Tesla — Automotive Core with Emerging Energy and Services
...
## Broadcom — AI Semiconductors Plus Infrastructure Software
...
## Meta Platforms — Advertising Economics Fund the AI and Reality Labs Bets
...
## Apple — iPhone Scale with a High-Margin Services Layer
...
## TSMC — HPC Replaces Smartphones as the Primary Platform
...
## Amazon — Retail Produces Scale; AWS Produces Disproportionate Profit
...
## Microsoft — The Most Balanced Enterprise Technology Platform
...
## Alphabet — Search Funds a Rapidly Scaling Cloud Business
...
## Cross-Company Business Comparison
...
## Long-Term Return and Risk Summary
...
## How to Read the Columns Together
...
## Downside Volatility Ranking: Holding Difficulty
...
## Recovery Ranking: Opportunity Cost of Being Underwater
...
## Typical Drawdown and Short-Horizon Loss Comparison
...
# Drawdown Frequency and Historical Rarity

## Historical Drawdown Recurrence
...
## Annual Historical Probability of Major Drawdowns
...
# Portfolio Classification and Entry Framework

## Which Companies Are Best Suited to Continuous Long-Term Ownership?
...
## Which Companies Are Better Bought Opportunistically?
...
## Suggested Drawdown Allocation Matrix
